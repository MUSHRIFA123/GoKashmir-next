...
export default function AttractionsPage() {
  ...
  useEffect(() => {
    fetch("/api/places")
      .then((res) => res.json())
      .then((data) => {
        const attractions = data.filter((p) => p.category_slug === "shopping");
  ...
  return (
    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <h1 className="text-4xl font-bold mb-8 text-center">Shoppings in Kashmir</h1>
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-4 gap-8">
          ...
          <aside className="w-full lg:col-span-1 lg:border-r lg:pr-6">
            <div className="bg-white rounded-xl p-4 shadow lg:shadow-none lg:sticky lg:top-24">
              <h3 className="font-semibold text-lg mb-3">Top Shopping Places</h3>
