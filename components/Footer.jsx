      ...
      <footer className="bg-gradient-to-r from-green-50 to-emerald-100 dark:from-gray-900 dark:to-black text-gray-900 dark:text-white py-12 px-4 font-inter border-t border-green-200 dark:border-gray-800">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="flex space-x-5 pt-2">
            ...
            {/* Facebook */}
            <a
              href="https://www.facebook.com/gokashmir"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-500 hover:text-green-600 dark:text-gray-400 dark:hover:text-emerald-400 transition-transform transform hover:scale-110"
            ...
            {/* LinkedIn */}
            <a
              href="https://www.linkedin.com/company/gokashmir"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-500 hover:text-green-600 dark:text-gray-400 dark:hover:text-emerald-400 transition-transform transform hover:scale-110"
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              <li><a href="/" className="text-gray-600 dark:text-gray-300 hover:text-green-600">Home</a></li>
              <li><a href="/about-kashmir" className="text-gray-600 dark:text-gray-300 hover:text-green-600">About Kashmir</a></li>
              <li><a href="/categories" className="text-gray-600 dark:text-gray-300 hover:text-green-600">Places to Visit</a></li>
              <li><a href="/seasons-and-weather" className="text-gray-600 dark:text-gray-300 hover:text-green-600">Best Time to Visit</a></li>
              <li><a href="/" className="text-gray-600 dark:text-gray-300 hover:text-green-600">Travel Blog</a></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              <li><a href="/itinearies" className="text-gray-600 dark:text-gray-300 hover:text-green-600">Itineraries</a></li>
              <li><a href="#tips" className="text-gray-600 dark:text-gray-300 hover:text-green-600">Travel Tips</a></li>
              {/* <li><a href="#faq" className="text-gray-600 dark:text-gray-300 hover:text-green-600">FAQs</a></li> */}
              <li><a href="/(fixed)/privacy-policy" className="text-gray-600 dark:text-gray-300 hover:text-green-600">Privacy Policy</a></li>
              <li><a href="#partner-with-us" className="text-gray-600 dark:text-gray-300 hover:text-green-600">Partner With Us</a></li>
            </ul>
          </div>
